...
## Overview
A simple python script, which can be installed on any *nix server to manage expired token deletion in a kong database, and notify admins via email afterwards.
